    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.URLField(blank=True, help_text='User avatar URL', null=True)),
                ('music_mood_weight', models.FloatField(default=0.5, help_text='How much music affects plant growth (0.0-1.0)')),
