    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_care_date', models.DateField(blank=True, help_text='Last date the plant was cared for', null=True)),
                ...
                ('decoration', models.ForeignKey(blank=True, limit_choices_to={'item_type': 'DECORATION'}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='plants_with_decoration', to='store.storeitem')),
                ('pot', models.ForeignKey(blank=True, limit_choices_to={'item_type': 'POT'}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='plants_in_pot', to='store.storeitem')),
